...
if ( is_single() ){
   ...
   if(preg_match('/<p>(.*)<\/p>/iU',trim(strip_tags($post->post_content,"<p>")),$result)){
    ...
    $post_content = $post_content_r['0'];
         ...
         $description = fun_utf8_substr($post_content,0,220);  
  } 
    $keywords = "";     
...
<meta name="description" content="<?php echo ot_get_option('opt_description'); ?>" />
<meta name="keywords" content="<?php echo ot_get_option('opt_keywords'); ?>" />
<?php } ?>
<?php if ( is_category() ) { ?>
<meta name="description" content="<?php echo strip_tags(category_description($cat_ID)); ?>" />
<meta name="keywords" content="<?php echo get_option('opt_keywords'); ?>" />
<?php } ?>
